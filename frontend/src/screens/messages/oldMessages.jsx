...
const Messages = () => {
  ...
  const sendTemplateMessage = async (template, parameters = {}) => {
    ...
    try {
      console.log(payload)
      const response = await axios.post(`https://graph.facebook.com/v20.0/${phoneNumberIndo.phon_no_id}/messages`, payload, {
        headers: {
          'Authorization': `Bearer EAADflsQXGB4BO8CScReoqDRXJZAfYSYntGSckaRN7V0AFYGgZAkYvmLRBBmJyVvaD6tLnoTBZC7bZATJKUiXFbbsq7QL1yZCxsFXqw3tIrm4Tc16lKEf6jXN8J7JqxBa41fk0NOYH4qUbW6HaxCRJdt1JlLXNvhc9Cz6pTDFTsLZBZB1OUak6iC00GeLkqOURG89GHZAMr1KsrvwI3fZAEcKw`,
